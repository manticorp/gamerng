...
K={},y={};let F=0,Q=0,T=Date.now(),L=0;class U extends Error{}var D=new WeakMap,B=new WeakMap,E=new WeakMap,ca=new WeakMap;class M{constructor(a){n(this,"version","0.2.3");l(this,D,0);l(this,B,void 0);l(this,E,void 0);l(this,ca,"normal gaussian boxMuller irwinHall bates batesgaussian bernoulli exponential pareto poisson hypergeometric rademacher binomial betaBinomial beta gamma studentsT wignerSemicircle kumaraswamy hermite chiSquared rayleigh logNormal cauchy laplace logistic".split(" "));this.setSeed(a)}getSeed(){return h(D,
this)}sameAs(a){return a instanceof M?this.getSeed()===a.getSeed()&&this.getRandomSource()===a.getRandomSource():!1}randomSource(a){m(B,this,a);return this}getRandomSource(){return h(B,this)}setSeed(a){if("undefined"!==typeof a&&null!==a)"string"===typeof a&&(a=this.convertStringToNumber(a)),m(D,this,a);else{a=this.setSeed;const b=Date.now();L=T===b?L+297357:0;T=b;return a.call(this,1E6*b+L)}return this}seed(a){this.setSeed(a);return this}serialize(){return{seed:h(D,this),version:"0.2.3"}}static unserialize(a){var b=
...
}dice(a,b,c){return this.diceExpanded(a,b,c).total}parseDiceString(a){const {constructor:b}=Object.getPrototypeOf(this);return b.parseDiceString(a)}clamp(a,b,c){"undefined"!==typeof c&&(a=a<=c?a:c);"undefined"!==typeof b&&(a=a>=b?a:b);return a}bin(a,b,c,d){g({val:a}).gt(c).lt(d);d-=c;return Math.round((a-c)/d*(b-1))/(b-1)*d+c}shuffle(a){a=[...a];for(let b=a.length-1;0<b;b--){const c=Math.floor(this.random()*(b+1));[a[b],a[c]]=[a[c],a[b]]}return a}}n(M,"version","0.2.3");class C extends M{static predictable(a){return new this(null!=
a?a:5789938451)}serialize(){return{seed:this.getSeed(),version:"0.2.3"}}sameAs(a){return a instanceof C?this.getRandomSource()===a.getRandomSource()&&this.getSeed()===a.getSeed():!1}from(a){this.setSeed(a.getSeed());return this}_next(){this.setSeed(this.getSeed()+2654435769|0);let a=this.getSeed();a=Math.imul(a^a>>>16,569420461);a=Math.imul(a^a>>>15,1935289751);return((a^a>>>15)>>>0)/4294967296}rotCompatible(){const a=this;return{getUniform(){return a.random()},getUniformInt(b,c){return a.randInt(b,
