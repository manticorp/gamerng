...
var GameRng=function(){function g(a){return"number"===typeof a||!isNaN(parseFloat(a))&&isFinite(a)}function e(a){if(Array.isArray(a))return new O(a);if("object"===typeof a){a=Object.entries(a);if(0===a.length)throw Error("Empty object provided");const [b,c]=a[0];return e(c).varname(b)}return new P(a)}function k(a=""){const b=1E3*Date.now();Q===b?H++:H=0;const c=(b+H).toString(16).replace(/\./g,"").padEnd(14,"0");Q=b;return`${a}${c}`}function m(a,...b){return Array.isArray(a)?a.reduce((c,d)=>c+d,0):
...
!f)throw new TypeError("Private accessor was defined without a setter");if("function"===typeof b?a!==b||!f:!b.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return"a"===d?f.call(a,c):f?f.value=c:b.set(a,c),c};const p=(a,b="Assertion failed")=>{if(!a)throw new X(b);};class X extends Error{}class O{constructor(a,b="numbers"){I.set(this,[]);this.name="numbers";this.numbers=a;this.name=b}get numbers(){return B(this,I,"f")}set numbers(a){for(const b of a)p("number"===
typeof b,`Non-number passed to validator ${b}`);C(this,I,a,"f")}all(a){this.numbers=a;return this}validate(a){return Array.isArray(a)?this.all(a):new P(a)}varname(a){this.name=a;return this}sum(){return this.numbers.reduce((a,b)=>a+b,0)}sumcloseto(a,b=1E-4,c){p(Math.abs(this.sum()-a)<b,null!==c&&void 0!==c?c:`Expected sum of ${this.name} to be within ${b} of ${a}, got ${this.sum()}`);return this}sumto(a,b){p(this.sum()===a,null!==b&&void 0!==b?b:`Expected sum of ${this.name} to be equal to ${a}, got ${this.sum()}`);
...
c:b.set(a,c),c};class S extends Error{}class Y extends Error{}class Z{constructor(a=[],b){v.set(this,[]);this.entries=a;this.rng=b?b:new E}copyArray(a){return Array.from(a)}setEntries(a){this.entries=a;return this}getEntries(){return y(this,v,"f")}set entries(a){R(this,v,this.copyArray(a),"f")}get entries(){return y(this,v,"f")}get length(){return y(this,v,"f").length}setRng(a){this.rng=a;return this}getRng(){return this.rng}add(a){y(this,v,"f").push(a)}empty(){R(this,v,[],"f");return this}isEmpty(){return 0>=
this.length}draw(){if(0===this.length)throw new S("No more elements left to draw from in pool.");if(1===this.length)return y(this,v,"f").splice(0,1)[0];const a=this.rng.randInt(0,y(this,v,"f").length-1);return y(this,v,"f").splice(a,1)[0]}drawMany(a){if(0>a)throw Error("Cannot draw < 0 elements from pool");if(0===this.length&&0<a)throw new S("No more elements left to draw from in pool.");if(this.length<a)throw new Y(`Tried to draw ${a} elements from pool with only ${this.length} entries.`);const b=
...
return"a"===d?f.call(a,c):f?f.value=c:b.set(a,c),c};const T=/^ *([+-]? *[0-9_]*) *[dD] *([0-9_]+) *([+-]? *[0-9_.]*) *$/,M={},x={};let H=0,Q=0,U=Date.now(),N=0;class V extends Error{}class W{constructor(a){this.version="0.2.0";F.set(this,0);D.set(this,void 0);G.set(this,void 0);da.set(this,"normal gaussian boxMuller irwinHall bates batesgaussian bernoulli exponential pareto poisson hypergeometric rademacher binomial betaBinomial beta gamma studentsT wignerSemicircle kumaraswamy hermite chiSquared rayleigh logNormal cauchy laplace logistic".split(" "));
this.setSeed(a)}getSeed(){return z(this,F,"f")}sameAs(a){return a instanceof W?this.getSeed()===a.getSeed()&&this.getRandomSource()===a.getRandomSource():!1}randomSource(a){L(this,D,a,"f");return this}getRandomSource(){return z(this,D,"f")}setSeed(a){if("undefined"!==typeof a&&null!==a)"string"===typeof a&&(a=this.convertStringToNumber(a)),L(this,F,a,"f");else{a=this.setSeed;const b=Date.now();N=U===b?N+297357:0;U=b;return a.call(this,1E6*b+N)}return this}seed(a){this.setSeed(a);return this}serialize(){return{seed:z(this,
F,"f"),version:"0.2.0"}}static unserialize(a,b=!1){var c;if((new w(null!==(c=a.version)&&void 0!==c?c:"0.1.0")).lt("0.2.0")&&!b)throw Error(`Trying to unserialize old RNG (v${a.version}) can lead to unexpected behaviour - minimum supported version for this iteration is ${"0.2.0"}.
...
e({d:b}).int(`Expected d to be an integer, got ${b}`);return{n:a,d:b,plus:c}}parseDiceArgs(a=1,b=6,c=0){const {constructor:d}=Object.getPrototypeOf(this);return d.parseDiceArgs(a,b,c)}static parseDiceString(a){if(!x[a]){var b=a.replace(/ +/g,"");if(/^[+-]*[\d.]+$/.test(b))return{n:0,d:0,plus:parseFloat(b)};T.test(a)&&(b=T.exec(b),null!==b&&(x[a]={n:parseInt(b[1]),d:parseInt(b[2]),plus:parseFloat(b[3])},Number.isNaN(x[a].n)&&(x[a].n=1),Number.isNaN(x[a].d)&&(x[a].d=6),Number.isNaN(x[a].plus)&&(x[a].plus=
...
typeof c&&(a=a<=c?a:c);"undefined"!==typeof b&&(a=a>=b?a:b);return a}bin(a,b,c,d){e({val:a}).gt(c).lt(d);d-=c;return Math.round((a-c)/d*(b-1))/(b-1)*d+c}}var F=new WeakMap;var D=new WeakMap;var G=new WeakMap;var da=new WeakMap;class E extends W{static predictable(a){return new this(null!==a&&void 0!==a?a:5789938451)}serialize(){return{seed:this.getSeed(),version:"0.2.0"}}sameAs(a){return a instanceof E?this.getRandomSource()===a.getRandomSource()&&this.getSeed()===a.getSeed():!1}from(a){this.setSeed(a.getSeed());
...
[];for(b=b.slice();b.length;){const d=b.indexOf(this.getItem(b));c.push(b.splice(d,1)[0])}return c},getWeightedValue(b){return a.weightedChoice(b)},getState(){return a.serialize()},setState(b){a.setSeed(b.seed);return this},clone(){return(new E).rotCompatible().setState(this.getState())}}}}return E}();
